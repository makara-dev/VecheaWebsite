...
@push('websites-css')
    {{-- custom css --}}
    <link rel="stylesheet" href="{{asset('css/websites/service/datanetwork.css')}}">
...
<div class="container" id="datanetwork">
    <div class="row">
        <div class="col-12">
            <h1 class="title text-center color-blue ">Data Networking</h1>
        </div>
    </div>
