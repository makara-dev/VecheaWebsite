...
@push('websites-css')
    {{-- custom css --}}
    <link rel="stylesheet" href="{{asset('css/websites/service/software.css')}}">
...
<div class="container" id="software">
    <div class="row">
        <div class="col-12">
            <h1 class="title text-center color-blue ">Software & Mobile Application</h1>
        </div>
    </div>
    ...
    <div class="row " >
        <div class="col-12 mt-3 web" id="web">
